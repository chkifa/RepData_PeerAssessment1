...
qplot(factor,steps, data=steps_weekend,geom="line",stat="identity",main ="Weekend")
qplot(factor,steps, data=steps_weekday,geom="line",stat="identity",main ="Weekday")
```
