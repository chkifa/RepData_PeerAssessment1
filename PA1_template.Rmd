...
qplot(interval,steps, data=steps_interval, xlab = deparse(substitute(interval)),geom="line",stat="identity",main ="Average number of steps taken per interval",xlab = "5 min interval")
```
